...
export const resolversEnhanceMap: ResolversEnhanceMap = {
  User: {
    user: [Authorized(Role.DEV, Role.ADMIN)],
    users: [Authorized(Role.ADMIN, Role.DEV)],
    updateUser: [Authorized(Role.INTERN, Role.DEV, Role.LEAD, Role.ADMIN)],
    deleteUser: [Authorized(Role.INTERN, Role.DEV, Role.LEAD, Role.ADMIN)],
  },
  Project: {
